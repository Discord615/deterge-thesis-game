...
public class ProcessSamplesScript : QuestStep
{
    ...
    private void OnTriggerStay(Collider other) {
        ...
        WordsearchManager.Instance.wordsearchData = WordSearchSOManager.instance.FluSymptoms;
        WordsearchManager.Instance.populateWSGrid();
        MinigameManager.instance.wordSearchQuestion.text = string.Format("Search for the symptoms of {0}", "Flu");
