...
public class ProcessSamplesScriptLast : QuestStep
{
    ...
    private void Start() {
        ...
        WordsearchManager.Instance.wordsearchData = WordSearchSOManager.instance.RabiesSymptoms;
        WordsearchManager.Instance.populateWSGrid();
        MinigameManager.instance.wordSearchQuestion.text = string.Format("Search for the symptoms of {0}", "Rabies");
