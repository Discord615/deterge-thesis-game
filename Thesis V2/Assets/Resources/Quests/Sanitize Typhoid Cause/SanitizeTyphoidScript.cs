...
public class SanitizeTyphoidScript : QuestStep
{
    ...
    private void Start() {
        ...
        objectiveOut.GetComponent<TextMeshProUGUI>().text = "Head back to the classroom and get rid of mosquitoes";
        
        sanitizeCue.SetActive(false);
        DialogueManager.instance.EnterDialogueMode(InkManager.instance.sanitizeRootInks[4]);
    }
