...
public class FindAndTalkScriptLast : QuestStep
{
    ...
    private void Start()
    {
        ...
        GlobalTimerManagaer.instance.initialTime = 300f;
        DialogueManager.instance.EnterDialogueMode(InkManager.instance.findSickInks[4]);
