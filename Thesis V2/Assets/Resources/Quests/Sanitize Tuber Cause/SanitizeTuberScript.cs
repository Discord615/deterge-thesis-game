...
public class SanitizeTuberScript : QuestStep
{
    ...
    private void Start() {
        ...
        objectiveOut.GetComponent<TextMeshProUGUI>().text = "Head back to kitchen to sanitize utensils";
        
        sanitizeCue.SetActive(false);
        DialogueManager.instance.EnterDialogueMode(InkManager.instance.sanitizeRootInks[1]);
    }
