...
=== Continuation ===
Now we can move onto movement. You can use the arrow keys or WASD to move your character. You can also hold left shift to run. Try walking towards the NPC.
